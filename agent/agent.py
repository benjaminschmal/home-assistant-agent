...
async def run_anthropic_agent(session,tools,user_message):
    ...
    for round_number in range(MAX_TOOL_ROUNDS):
        # Ask Claude to use a tool whenever the request requires live Home Assistant data.
        # `auto` is retained for general questions, while the system prompt explicitly
        # requires tools for HA state/device questions.
